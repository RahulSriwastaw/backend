...
try {
  ...
  // This allows server to run even if Firebase Admin fails
 ...
 * @throws {Error} If token is invalid, expired, or Firebase Admin is not initialized
 */
export const verifyFirebaseToken = async (idToken) => {
  ...
  try {
    ...
    const userInfo = {
      ...
      firebase_claims: decodedToken, // Include all Firebase claims
    };
...
// Export Firebase Admin instance for direct access if needed
